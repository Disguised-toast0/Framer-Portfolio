...
const Layout = () => {
  ...
  return (
    <UserProvider value={{ play, setplaying }}>
      ...
      <div
        id="progress"
        className="fixed bottom-0 left-0 h-1 rounded-4xl bg-purple-400 z-50"
      />
      <Navbar />
              ...
              >
                {index === 2 && (
                  <motion.h1
                    ...
                    className="text-black font-fancy sm:text-4xl text-xl font-bold  tracking-wider h-full flex items-center justify-center"
                  >
                    {transitionText}
                  </motion.h1>
                )}
