          ...
          {skills.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
                onClick={() =>
                  isMobile && setActiveIndex(isActive ? null : index)
                }
              >
                <div
                ...
                >
                  ...
                  <div className="flex-1 w-full">
                    <div className="relative w-full h-[150px] sm:h-[300px] overflow-hidden">
                      <motion.img
                        src={`/${item.img?.[0] || "skill-img1"}.webp`}
                        alt="preview"
                        loading="lazy"
                        decoding="async"
                        className="absolute w-full h-full object-cover will-change-transform transform-gpu"
                        animate={
                          isMobile
                            ? { y: isActive ? "-100%" : "0%" }
                            : undefined
                      ...
                      <motion.img
                        src={`/${item.img?.[1] || "skill-img2"}.webp`}
                        alt="preview"
                        loading="lazy"
                        decoding="async"
                        className="absolute w-full h-full object-cover will-change-transform transform-gpu"
