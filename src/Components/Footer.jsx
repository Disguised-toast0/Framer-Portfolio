      ...
      <div>
        ...
        <div className='flex sm:gap-x-45 font-secondary sm:justify-start justify-between pt-10 '>
            ...
            <div>
                ...
                <a href='https://x.com/the_piyush_k' target='_blank' aria-label='Twitter'>
                <h1 className='sm:text-xl text-sm'>@the_piyush_k</h1></a>
            </div>
        </div>
      </div>
        ...
        <ul className='sm:flex flex-wrap py-6 px-4 sm:text-4xl text-2xl gap-6 cursor-pointer font-bold'>
          <li className='hover:text-yellow-300'><a href='https://medium.com/@piyushk2325' target='_blank' aria-label='Medium'>Medium</a></li>
        ...
        <h1 className='lg:text-[190px]  text-6xl font-primary font-bold text-orange-400 '>@itspiyushk</h1>
